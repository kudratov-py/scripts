...
read -p -r "Enter a new computer name in the domain: " pcname
read -p -r "Enter a domain name: " domain
...
read -p -r "Add administrator on PC. Enter ADMIN username: " admin
...
read -t 5 -p -r "Please choose - Create home directory on login"
...
echo -e "$tcLtGRN"; read -t 3 -p -r "Rebooting the system."; echo -e "$tcLtGRN"
sudo reboot
